...
date = 2026-05-16T10:05:00Z
draft = false
categories = ["Accessibility", "Technology"]
tags = ["VirtualReality", "Haptics", "Gaming", "Innovation"]
description = "Haptic feedback and eye-tracking started as essential tools for accessibility before driving the next generation of consumer tech like VR and gaming."
+++

When considering modern video games and Virtual Reality (VR), we often focus on graphics and processing power. Yet two critical technologies driving this immersion—haptic feedback and eye-tracking—originated as accessibility tools.

### Haptic Feedback: Communicating Through Touch

Haptic feedback uses tactile sensations, like vibrations, to convey information. We encounter it daily: the subtle click of a smartphone keyboard, a smartwatch notification tap, or a game controller rumbling to simulate walking through mud.
...
### Eye-Tracking: From ALS to the Metaverse

Eye-tracking technology offers another powerful example of the digital curb-cut effect.
